...
async function testTasksAPI() {
  try {
    ...
    const allRes = await axios.get(`${API_BASE}/tasks`, { headers });
    ...
    const singleRes = await axios.get(`${API_BASE}/tasks/${taskId}`, { headers });
    ...
    const toggleRes = await axios.patch(`${API_BASE}/tasks/${taskId}/toggle`, {}, { headers });
    ...
    const toggleRes2 = await axios.patch(`${API_BASE}/tasks/${taskId}/toggle`, {}, { headers });
    ...
    const finalRes = await axios.get(`${API_BASE}/tasks`, { headers });
    ...
    const deleteRes = await axios.delete(`${API_BASE}/tasks/${taskId}`, { headers });
    console.log(`   ✅ Task deleted\n`);

    // Step 11: Verify deletion
    console.log('1️⃣1️⃣ Verifying deletion...');
    const afterDeleteRes = await axios.get(`${API_BASE}/tasks`, { headers });
